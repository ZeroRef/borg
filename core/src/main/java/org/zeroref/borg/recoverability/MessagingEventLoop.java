...
public class MessagingEventLoop implements Closeable, ManagedEventLoop {
    private String name;
    ...
    public MessagingEventLoop(String name, String kafka, List<String> inputTopics, DispatchMessagesToHandlers router) {
        this.name = name;
        this.kafka = kafka;
